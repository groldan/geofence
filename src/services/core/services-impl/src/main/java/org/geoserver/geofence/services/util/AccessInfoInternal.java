...
/**
 * This class is used internally when merging restrictedArea, because it deals with Geometries and
 * not with WKT strings. Also note the collections here can be null, where {@link AccessInfo
 * AccessInfo} collections are initt'ed.
 *
...
public class AccessInfoInternal implements Serializable {
    ...
    //     */
    //    public static final AccessInfoInternal ALLOW_ALL = new
    // AccessInfoInternal(GrantType.ALLOW);
    //
    //    /**
    ...
    public AccessInfo toAccessInfo() {
        ...
        ret.setAllowedStyles(
                allowedStyles == null
                        ? null
                        : new HashSet(allowedStyles)); // new Set will prevent marshalling hibernate
        // classes
        ...
        if (area != null) ret.setAreaWkt(area.toText());
