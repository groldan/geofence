 ...
 * name.
 *
 * <p>TODO: (groldan) for the sake of design quality, revisit and split out an equivalent class in
 * services-api, with a mapper in services-api-impl to persistence-api filter, so services-api does
 * not depend on presistence-api?
 *
...
public class RuleFilter implements Serializable, Cloneable {
    ...
    public static class TextFilter implements Serializable, Cloneable {
        ...
        public void set(TextFilter copyFrom) {
            text = copyFrom.getText();
            type = copyFrom.type;
            forceUppercase = copyFrom.forceUppercase;
            includeDefault = copyFrom.includeDefault;
        }
