...
public class SearchUtil {
    ...
    /**
     * Adds a search field for finding the precise addressrange instance. Does <b>NOT</b> search for
     * an address in a range.
     */
    public static void addAddressRangeSearch(Search search, JPAIPAddressRange addressRange) {
