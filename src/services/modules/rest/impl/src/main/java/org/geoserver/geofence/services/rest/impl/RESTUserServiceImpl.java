...
public class RESTUserServiceImpl extends BaseRESTServiceImpl implements RESTUserService {
    ...
    private void addIntoGroup(IdName userId, IdName groupId)
    ...
    public void removeFromGroup(String userName, String groupName)
            throws NotFoundRestEx, InternalErrorRestEx, BadRequestRestEx {
        removeFromGroup(new IdName(userName), new IdName(groupName));
    }

    private void removeFromGroup(IdName userId, IdName groupId)
            throws InternalErrorRestEx, BadRequestRestEx, NotFoundRestEx {
        try {
