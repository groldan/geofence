...
public class RuleServiceHelper {
    ...
    public long count(RuleFilter ruleFilter) {
        return count(
                ruleFilter.getUser(),
                ruleFilter.getRole(),
                ruleFilter.getInstance(),
                ruleFilter.getService(),
                ruleFilter.getRequest(),
                ruleFilter.getWorkspace(),
                ruleFilter.getLayer());
    }

    public long count(
            RuleFilter.TextFilter userFilter,
            RuleFilter.TextFilter ruleFilter,
            RuleFilter.IdNameFilter instanceFilter,
            RuleFilter.TextFilter serviceFilter,
            RuleFilter.TextFilter requestFilter,
            RuleFilter.TextFilter workspaceFilter,
            RuleFilter.TextFilter layerFilter) {
        ...
        return ruleService.count(
                ...
                //                userFilter==null?null: (userFilter.isIncludeDefault() ||
                // userFilter.getType() == RuleFilter.FilterType.DEFAULT),
                getFilterName(userFilter),
                getFilterDefault(userFilter),
                ...
                getFilterName(ruleFilter),
                getFilterDefault(ruleFilter),
                ...
                getFilterId(instanceFilter),
                getFilterName(instanceFilter),
                getFilterDefault(instanceFilter),
                ...
                getFilterName(serviceFilter),
                getFilterDefault(serviceFilter),
                ...
                getFilterName(requestFilter),
                getFilterDefault(requestFilter),
                ...
                getFilterName(workspaceFilter),
                getFilterDefault(workspaceFilter),
                ...
                getFilterName(layerFilter),
                getFilterDefault(layerFilter));
    }

    private static Long getFilterId(RuleFilter.IdNameFilter filter) {
        return filter == null
                ? null
                : filter.getType() == RuleFilter.FilterType.IDVALUE ? filter.getId() : null;
    }

    private static String getFilterName(RuleFilter.IdNameFilter filter) {
        return filter == null
                ? null
                : filter.getType() == RuleFilter.FilterType.NAMEVALUE ? filter.getName() : null;
    }
    ...
    private static String getFilterName(RuleFilter.TextFilter filter) {
        return filter == null
                ? null
                : filter.getType() == RuleFilter.FilterType.NAMEVALUE ? filter.getText() : null;
    }
    ...
    public RESTOutputRuleList get(
            Integer page, Integer entries, boolean full, RuleFilter ruleFilter) {
        return get(
                page,
                entries,
                full,
