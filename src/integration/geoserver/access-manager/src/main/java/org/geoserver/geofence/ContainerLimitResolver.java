...
class ContainerLimitResolver {
    ...
    private ProcessingResult unionAccesses(
        ...
        if (intersectProcessG != null) {
            ...
            CatalogMode = AccessInfoUtils.getLarger(null, intersectProcessG.getCatalogMode());
        }
        if (clipProcessG != null) {
            ...
            CatalogMode = AccessInfoUtils.getLarger(CatalogMode, clipProcessG.getCatalogMode());
        }
        ...
        if (bothProcessG != null) {
            ...
            CatalogMode = AccessInfoUtils.getLarger(CatalogMode, bothProcessG.getCatalogMode());
        }
        ...
        if (intersectProcessL != null) {
            ...
            CatalogMode =
                    AccessInfoUtils.getLarger(CatalogMode, intersectProcessL.getCatalogMode());
        }
        if (clipProcessL != null) {
            ...
            CatalogMode = AccessInfoUtils.getLarger(CatalogMode, clipProcessL.getCatalogMode());
        }
        ...
        if (bothProcessL != null) {
            ...
            CatalogMode = AccessInfoUtils.getLarger(CatalogMode, bothProcessL.getCatalogMode());
        }
    ...
    private ProcessingResult enlargeGroupProcessingResult(List<ProcessingResult> processingResult) {
        ...
        for (int i = 0; i < processingResult.size(); i++) {
            ...
            CatalogMode = AccessInfoUtils.getLarger(CatalogMode, pr.getCatalogMode());
    ...
    private void intersectAccesses(
        ...
        Geometry resIntersectArea = JTS.to(resAccessInfo.getArea());
        Geometry resClipArea = JTS.to(resAccessInfo.getClipArea());
        ...
        if (groupsAccessInfo != null && !groupsAccessInfo.isEmpty()) {
            for (int i = 0; i < groupsAccessInfo.size(); i++) {
                ...
                Geometry clipArea = JTS.to(accessInfo.getClipArea());
                if (!groupOnIntersect) groupOnIntersect = area != null;
                if (!groupOnClip) groupOnClip = clipArea != null;
    ...
    static class ProcessingResult {
        ...
        ProcessingResult(Geometry intersectArea, Geometry clipArea, CatalogMode CatalogMode) {
